			 ...
			 obj.oplayer.events.on({
				...
				"featureselected":function(e){
					...
					if(e.feature.cluster){
	         			html="<div class='popup'><ul><li><img src='images/1359925009_twitter_02.png' width=20px />&nbsp; &nbsp; <b>"+ e.feature.cluster[0].attributes["user_name"]+"</b>: "+ e.feature.cluster[0].attributes["text"]+"</li></ul>";
	                	...
	                	if(e.feature.cluster.length>1){
							...
							$.each(e.feature.cluster, function(i,feature){
								html+="<li><img src='images/1359925009_twitter_02.png' width=20px />&nbsp; &nbsp; <b>"+ feature.attributes["user_name"]+"</b>: "+ feature.attributes["text"]+"</li>";
							});
							html+="</ul>"
		               	}		
	               	} 
